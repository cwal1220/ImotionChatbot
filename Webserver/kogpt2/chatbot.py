...
class Chatbot() :
    def __init__(self):
        ...
        self.parser = KoGPT2Chat.add_model_specific_args(parser)
        self.parser = Trainer.add_argparse_args(parser)
        self.args = parser.parse_args()
        self.model = KoGPT2Chat(self.args)
        self.model = self.model.load_from_checkpoint(self.args.model_params)

    def predict(self, sent):
        return self.model.chat(sent)
